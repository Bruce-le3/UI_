...
namespace Justech
{
    public class GClsConfigFile
    {
        ...
        public GClsConfigFile(string path)
        {
                                ...
                                string defaultValue)
        {
            ...
            lock (_locks[m_path])
            {
                StringBuilder retval = new StringBuilder(GClsConfigFile.MaxSectionSize);

                NativeMethods.GetPrivateProfileString(sectionName,
                                                      keyName,
                                                      defaultValue,
                                                      retval,
                                                      GClsConfigFile.MaxSectionSize,
                                                      m_path);
        ...
        public List<KeyValuePair<string, string>> GetSectionValuesAsList(string sectionName)
        {
            ...
            IntPtr ptr = Marshal.AllocCoTaskMem(GClsConfigFile.MaxSectionSize);
        ...
        public string[] GetSectionNames()
        {
            ...
            try
            {
                ...
                lock (_locks[m_path])
                {
                    ...
                    GClsConfigFile.MaxSectionSize, m_path);
        ...
        public  static GClsConfigFile configFile;  //定义配置文件
        public static string ReadConfig(string FileName, string label, string name, String defultVal)  //读配置文件
        {
            string ret;
            configFile = new GClsConfigFile(Application.StartupPath + "/Config/" + FileName);
            ret = configFile.GetString(label, name, defultVal);

            if (ret == defultVal)
            {
                configFile.WriteValue(label, name, defultVal);
            }
        ...
        public static void WriteConfig(string FileName, string label, string name, String defultVal)  //写配置文件
        {
